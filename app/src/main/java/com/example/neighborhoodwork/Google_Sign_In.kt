...
import com.example.googlesigninexample.DetailsActivity
...
import kotlinx.android.synthetic.main.activity_google__sign__in.*
...
class Google_Sign_In : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN).requestIdToken("9001").requestEmail().build()
